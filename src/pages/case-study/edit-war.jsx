        ...
        <Container className="relative w-1/2 mx-auto">
            <div class="entry-content content leading-tight text-sm">
                <div class="entry-content content">
                    ...
                    <p>First, I authored a complete, revamped draft of the page with 50+ citations. The draft included the controversies the other editor was interested in but was more balanced and complete overall. I hammered out the content of the draft with the client over several weeks, sometimes going over it line-by-line or word-by-word. Controversial pages can be more difficult to get approved internally. The draft included information that was harmful to the client’s brand and allegations they felt were untrue. Eventually, we reached a “final” version we were prepared to share with Wikipedia’s editors.</p>
                    <p>On Wikipedia, we started going through the page section-by-section or paragraph-by-paragraph. Over more than 10 pages of discussion, we hammered out the issues with the client’s competitor. In some instances, we found a compromise. In others, we got a third, independent editor to provide an outside opinion.</p>
                    <p>The end result was extraordinary in two ways. First, our collaboration eventually resulted in a very neutral and comprehensive page. The page was ranked as being among the top 1% best pages on Wikipedia with the “Good Article” designation. In my opinion, it was even more neutral as a result of the collaboration between two editors with opposing motives.</p>
                    <p>Second, we established a friendly, long-term, collaborative relationship with the other editor. In the future, we were able to talk about new additions and collaborate on other content changes long-term. This was the epitome of Wikipedia’s <a href="https://en.wikipedia.org/wiki/Wikipedia:Assume_good_faith">Assume Good Faith</a> principle. Conflict was natural given our respective interests in the page, but a bit of patience and civility went a long way. The results were a win-win for everyone, including the client and Wikipedia.</p>
                </div>
            </div>
        </Container>
    </section>
